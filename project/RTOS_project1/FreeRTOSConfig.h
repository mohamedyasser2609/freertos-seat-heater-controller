...
#define configTOTAL_HEAP_SIZE                   ((size_t)(16384))  /* Increased to 16KB */
...
#define configTIMER_TASK_STACK_DEPTH            (configMINIMAL_STACK_SIZE + 32)
...
#define configMAX_API_CALL_INTERRUPT_PRIORITY   (5 << 5)  /* Priority 5 */
